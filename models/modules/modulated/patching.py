...
class Patching_Modulated(nn.Module):
    def __init__(self, 
                 embed_dim, 
                 patch_size,
                 mod_dims,
        ...
        self.mod = Modulator(mod_dims, embed_dim, n_unsqueeze=2, channel_last=False)
...
class UnPatching_Modulated(nn.Module):
    def __init__(self, 
        ...
        self.mod = Modulator(mod_dims, embed_dim, n_unsqueeze=2)
